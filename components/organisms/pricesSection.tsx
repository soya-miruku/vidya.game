...
import { VSimpleTabs } from '../atoms/VSimpleTabs';
...
export const PricesSection: React.FC<IPricesSectionProps> = ({tokenId = 'vidya', source="coinGecko"}) => {
  ...
  return (
    <div className='w-full h-full flex flex-col justify-center items-center'>
      ...
      <div className='flex justify-between items-center w-full h-full sm:px-vxl px-vlrg'>
        <VSimpleTabs defaultActiveIndex={0} items={[{label: 'USD', value: 'usd'},{label: 'ETH', value: 'eth'}]} onChange={(val, index) => setCurrencySelected(val)}/>
