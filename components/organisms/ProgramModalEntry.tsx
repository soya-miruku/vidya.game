...
export const ProgramModalWrapper = ({title, children, onClose}: IProgramWrapperProps) => {
  return (
    <Modal onClose={onClose} className="h-full sm:p-vlrg flex flex-col">
      <div className="w-full h-full flex flex-col dark:bg-dark-300/60 backdrop-blur-lg bg-light-200/90 justify-center items-center rounded-xl">
        <div className="w-full flex justify-end p-vmd items-center border-b-[1px] dark:border-b-light-500/30 border-b-light-500">
          ...
          <button onClick={onClose} type="button" className="bg-transparent text-accent-dark-200 dark:hover:bg-light-300 hover:bg-dark-300/70 rounded-lg text-sm p-vsm ml-auto inline-flex items-center">
