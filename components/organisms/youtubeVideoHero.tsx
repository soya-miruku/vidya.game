...
export interface IYoutubeVideoHeroProps {
  videoId?: string;
  videoUrl?: string;
  videoTitle?: string;
  videoDesc?: string;
...
export const YoutubeVideoHero: React.FC<IYoutubeVideoHeroProps> = ({ hideTitleWhenPlaying, fetchTitleFromVideo, videoId, videoTitle, videoDesc, canEdit}) => {
