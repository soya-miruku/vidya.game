  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <Text
          renderBlock={(props) => (
            <h1 className="text-3xl sm:text-4xl text-center font-black text-gray-500 dark:text-white leading-tight mb-3">
              {props.children}
            </h1>
          )}
        ...
        <RichText
          renderBlock={(props) => (
            <p className="text-xl text-center leading-relaxed text-gray-300 dark:text-gray-100">
              {props.children}
            </p>
          )}
